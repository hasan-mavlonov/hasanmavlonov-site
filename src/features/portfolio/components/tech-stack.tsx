                    ...
                    return (
                      <li key={item.key} className="flex">
                        <a
                          ...
                          target="_blank"
                          rel="noopener"
                          className="flex h-(--badge-height) items-center justify-center gap-1.25 bg-muted/60 px-2 font-mono text-xs text-foreground inset-ring-1 inset-ring-border [&_svg]:pointer-events-none [&_svg]:size-3.5 [&_svg]:shrink-0 [&_svg]:text-muted-foreground/80"
                        >
                          {item.icon}
                          {item.title}
                        </a>
